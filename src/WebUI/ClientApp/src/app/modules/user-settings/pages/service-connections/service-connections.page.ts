...
export class ServiceConnectionsPage {
  ...
  redirectToDiscord() {
    window.location.href = "https://discord.com/api/oauth2/authorize?client_id=971200529013309461&redirect_uri=https%3A%2F%2Fwe-share-live.de%2Fc%2Fdiscord-callback&response_type=code&scope=identify";
  }
}
