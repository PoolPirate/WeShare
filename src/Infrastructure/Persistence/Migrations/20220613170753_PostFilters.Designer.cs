...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.PostFilter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PostFilters", (string)null);
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.PostSendFailure", b =>
                {
                    ...
                    b.HasIndex("PostId", "SubscriptionId");
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.ServiceConnection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.DiscordConnection", b =>
                {
                    b.HasBaseType("WeShare.Domain.Entities.ServiceConnection");
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.JsonSchemaPostFilter", b =>
                {
                    b.HasBaseType("WeShare.Domain.Entities.PostFilter");
            ...
            modelBuilder.Entity("WeShare.Domain.Entities.PostSendFailure", b =>
                {
                    b.HasOne("WeShare.Domain.Entities.SentPost", "SentPost")
                        .WithMany("PostSendFailures")
                        .HasForeignKey("PostId", "SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
